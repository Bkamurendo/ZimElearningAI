...
export default function AdminDashboardClient({
  ...
  const adminTabs = [
    ...
    { id: 'platform', label: 'Platform', icon: <Cpu size={16} /> },
    { id: 'content', label: 'Content', icon: <Database size={16} /> },
    { id: 'analytics', label: 'Insights', icon: <TrendingUp size={16} /> }
  ]
          ...
          {endingTodayCount > 0 && (
            <div className="bg-rose-500 text-white rounded-2xl p-4 flex items-center justify-between shadow-lg shadow-rose-500/20 animate-pulse">
               <div className="flex items-center gap-3">
                 ...
                 <div>
                    <p className="font-black uppercase tracking-tight text-sm">{endingTodayCount} TRIIALS EXPIRING TODAY</p>
                    ...
                    <div className="flex-1 space-y-6">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                             ...
                             <p className="text-[10px] text-slate-500 mt-2">{((paidUsers.length / totalUsers) * 100).toFixed(1)}% Conversion Rate</p>
                          </div>
                       </div>
                    </div>
                             ...
                             <div key={month} className="flex-1 space-y-2 group">
                                <div className="relative w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg overflow-hidden h-full flex flex-col justify-end">
                                   <div 
                                      ...
                                      style={{ height: `${(count / Math.max(...Object.values(cohortByMonth))) * 100}%` }}
                                   />
                                </div>
