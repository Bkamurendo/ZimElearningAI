          ...
          <div className="relative">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  ...
                  {(pendingSubmissions ?? 0) > 0 && (
                    <span className="inline-flex items-center gap-1.5 bg-amber-400/30 text-white text-xs font-semibold px-3 py-1 rounded-full">
                      <Clock size={11} />
              ...
              <div className="flex-shrink-0 bg-white/15 backdrop-blur-sm rounded-2xl px-4 py-3 text-center hidden sm:block border border-white/20">
                ...
                <p className="text-blue-100 text-xs mt-0.5 font-medium">Total content</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400">Manage lessons &amp; content</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400">Create &amp; grade student work</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-semibold text-gray-900">AI Generator</p>
                <p className="text-sm text-gray-400">Generate teaching materials</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-gray-700 group-hover:text-blue-700 transition text-sm">New Course</p>
                  <p className="text-xs text-gray-400">Create course</p>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-gray-700 group-hover:text-emerald-700 transition text-sm">New Task</p>
                  <p className="text-xs text-gray-400">Assign work</p>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold text-gray-800">Submissions to Grade</h2>
                <span className="text-xs bg-amber-500 text-white font-bold px-1.5 py-0.5 rounded-full">
                  {pendingSubmissions}
                </span>
              </div>
              <Link href="/teacher/assignments" className="text-xs text-blue-600 font-semibold hover:text-blue-700 transition flex items-center gap-1">
            ...
            <div className="divide-y divide-gray-50">
              {(recentSubs ?? []).map((sub) => (
                ...
                >
                  ...
                  <span className="text-xs text-amber-700 font-semibold bg-amber-100 px-3 py-1.5 rounded-full group-hover:bg-amber-200 transition flex items-center gap-1">
