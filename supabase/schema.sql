...
INSERT INTO public.subjects (name, code, zimsec_level) VALUES
  ...
  -- O-LEVEL (Heritage-Based Curriculum 2024-2030)
  -- Compulsory 5: Mathematics, English Language, Heritage Studies, Combined Science + 1 Indigenous Language
  ...
  -- PE & Arts
  ('Physical Education and Sport',   'OL-PE',     'olevel'),
  ('Art and Design',                 'OL-ART',    'olevel'),
  ('Music',                          'OL-MUS',    'olevel'),
  ...
  ('Food and Nutrition',             'OL-FN',     'olevel'),
  ...
  -- A-LEVEL (Heritage-Based Curriculum 2024-2030)
  -- 3 specialisation subjects + 1 complementary
  ('Mathematics',                    'AL-PMATH',  'alevel'),
